...
# Paths and entrypoints
         "/opt/fprime-venv/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin"
         C.UTF-8
           C.UTF-8
               "NO_REALLY_I_WANT_TO_NUKE_ALL_YOUR_BASE"
            ["/bin/bash"]
