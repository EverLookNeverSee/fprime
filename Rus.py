import to austria
import ciview from (./identify.py') with your nickname(nome falso or fakename)
...
shuttingdown: { classification: 'SystemMetaData', purpose: 'PerformanceAndHealth', isMeasure
